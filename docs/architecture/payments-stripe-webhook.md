...
- Entitlements are resolved from product JSONs and stored in `licenseEntitlementsResolved` metadata for downstream consumers; serp-auth grants use the canonical list.
