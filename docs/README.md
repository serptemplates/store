...
This folder collects the architecture, operations, runbooks, and data notes for the store.

## Architecture

- `architecture/checkout-overview.md` - Checkout flow and post-purchase processing.
...
- `architecture/trademark-compliance.md` - Trademark and compliance notes.
- `architecture/why-sanitize-with-react-hook-form.md` - Form sanitization rationale.
- `architecture/optimize-js-execution.md` - Performance notes.

## Operations

- `operations/store-deployment.md` - Deployment overview and verification steps.
- `operations/env-files.md` - Local env file layout and key variables.
...
- `runbooks/how-to-update-price-stripe.md` - Stripe price update runbook.
- `TODO.md` - Active documentation TODOs.
<<<<<<< HEAD
=======
