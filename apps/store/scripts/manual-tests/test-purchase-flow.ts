...
function createMockCheckoutSession(): Stripe.Checkout.Session {
  ...
  return {
    ...
    metadata: {
      ...
      productPageUrl: "https://store.serp.co/product-details/product/linkedin-learning-downloader",
      store_serp_co_product_page_url: "https://store.serp.co/product-details/product/linkedin-learning-downloader",
