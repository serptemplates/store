...
description: "**File Extensions**: `.webm`   **MIME Types**: `video/webm`,
  `audio/webm`   **Container**: Matroska-based multimedia
  container   **Codecs**: VP8, VP9, AV1 (video), Vorbis, Opus (audio)"
seoDescription: "**File Extensions**: `.webm`   **MIME Types**: `video/webm`,
  `audio/webm`   **Container**: Matroska-based multimedia
  container   **Codecs**: VP8, VP9, AV1 (video), Vorbis, Opus (audio)"
